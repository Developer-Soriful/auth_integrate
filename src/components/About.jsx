    ...
    <div className="w-11/12 mx-auto py-10 text-white space-y-6">
      ...
      <section>
        ...
        <p className="text-indigo-200">
          Our goal is to bring the most useful, trending and secure apps in one
          place. Whether you're looking for productivity tools or fun games,
          this store helps you find them easily.
        </p>
      </section>
      ...
      <section>
        ...
        <p className="text-indigo-200">
          All apps listed here are reviewed and safe to explore. We don’t allow
          harmful content.
        </p>
      </section>
    </div>
